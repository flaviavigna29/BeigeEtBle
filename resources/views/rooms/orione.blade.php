<x-layout>
    <div class="room-section container-fluid pt-5 px-0 mx-0 Playfair">
        {{-- header --}}
        <div class="row header-image-orione pt-5">
            <div class="col-12 col-lg-6 d-flex justify-content-center align-items-center">
                <div class="py-5 px-4 px-md-5 d-flex flex-column room-description">
                    <h1>Orione</h1>
                    <h2>"{{ __('ui.room_desc_orione_subtitle') }}"</h2>
                    <p class="border_ocra_2"></p>
                    <p class="ps-lg-4 Roboto text-uppercase fw-bold">
                        <small>{{ __('ui.room_desc_orione_type') }}</small>
                    </p>
                    <p class="ps-lg-4">
                        {{ __('ui.room_desc_orione_description_1') }}
                    </p>
                    <p class="ps-lg-4">
                        {{ __('ui.room_desc_orione_description_2') }}
                    </p>
                </div>
            </div>
        ...
        {{-- faq e services --}}
        <div class="row py-5 section-image-orione d-flex justify-content-around px-5">
            ...
            <div class="col-12 col-lg-4 d-flex justify-content-center mt-5 mt-lg-0">
                <div style="width:420px;">
                    ...
                    <ul class="list-unstyled ps-0 Roboto">
                        ...
                        <li class="pb-4"><i class="fas fa-bed me-4"></i> {{ __('ui.room_bed_orione') }}</li>
        ...
        <div class="row py-5 px-md-5 gallery px-1">
            ...
            <div class="col-12 col-lg-6 my-2">
                <img src="{{ asset('storage/rooms_page/orione/BRG_9790.jpg') }}" alt="Img 1" class="img-fluid">
            </div>
            <div class="col-12 col-lg-6 my-2">
                <img src="{{ asset('storage/rooms_page/orione/BRG_9793.jpg') }}" alt="Img 1" class="img-fluid">
            </div>
            <div class="col-12 col-lg-3 my-2">
                <img src="{{ asset('storage/rooms_page/orione/BRG_9796.jpg') }}" alt="Img 1" class="img-fluid">
            </div>
            <div class="col-12 col-lg-3 my-2">
                <img src="{{ asset('storage/rooms_page/orione/BRG_9813.jpg') }}" alt="Img 1" class="img-fluid">
            </div>
            <div class="col-12 col-lg-3 my-2">
                <img src="{{ asset('storage/rooms_page/orione/BRG_9930.jpg') }}" alt="Img 1" class="img-fluid">
            </div>
            <div class="col-12 col-lg-3 my-2">
                <img src="{{ asset('storage/rooms_page/orione/BRG_9932.jpg') }}" alt="Img 1" class="img-fluid">
            </div>
            <div class="col-12 col-lg-6 my-2">
                <img src="{{ asset('storage/rooms_page/orione/BRG_9950.jpg') }}" alt="Img 1" class="img-fluid">
            </div>
            <div class="col-12 col-lg-6 my-2">
                <img src="{{ asset('storage/rooms_page/orione/BRG_9956.jpg') }}" alt="Img 1" class="img-fluid">
            </div>
            <div class="col-12 col-lg-3 my-2">
                <img src="{{ asset('storage/rooms_page/orione/BRG_9957.jpg') }}" alt="Img 1"
                    class="img-fluid">
            </div>
            <div class="col-12 col-lg-3 my-2">
                <img src="{{ asset('storage/rooms_page/orione/BRG_9960.jpg') }}" alt="Img 1"
                    class="img-fluid">
            </div>
            <div class="col-12 col-lg-3 my-2">
                <img src="{{ asset('storage/rooms_page/orione/BRG_9964.jpg') }}" alt="Img 1"
                    class="img-fluid">
            </div>
            <div class="col-12 col-lg-3 my-2">
                <img src="{{ asset('storage/rooms_page/orione/BRG_9970.jpg') }}" alt="Img 1"
                    class="img-fluid">
            </div>
        </div>
    </div>
