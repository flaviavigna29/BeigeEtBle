<x-layout>
    {{-- Home Section --}}
    <div class="home-section container-fluid pt-5 px-0 mx-0">
        ...
        <div class="section-3 row m-0 d-flex justify-content-around">
            <div class="col-12 col-md-4 px-5">
                ...
                <p>Perfect for <strong>tourism</strong>, <strong>work</strong>, or <strong>leisure</strong>, our
                    location allows you to take advantage of convenience and live an authentic experience
                    without wasting time on transportation.</p>
            </div>
            <div class="col-12 col-md-5 px-5">
        ...
        <div class="section-4 row m-0 d-flex justify-content-around">
            ...
            <div class="col-12 col-md-5 px-5">
                <div class="card_home py-5 px-4 px-md-5 d-flex flex-column justify-content-center">
                    ...
                    <span class="mb-0 pb-3">Start your day with a light <strong>continental breakfast</strong> offered
                        by Espressamente
                        Illy
                        and savor an exclusive <strong>Italian lunch</strong> in the heart of Rome.</span>
                    <span class="mb-0 pb-3">Enjoy the wide selection of dishes and impeccable hospitality of the
                        <strong>Espressamente
                            Illy</strong> staff, who will make every meal an unforgettable and authentically
                        <strong>Italian experience</strong>!</span>
                </div>
            </div>
        </div>
